                 ...
                 OS_ERR  *p_err)
{
    ...
    if (p_tcb == &OSIdleTaskTCB[0] || p_tcb == &OSIdleTaskTCB[1]) {                          /* Not allowed to delete the idle task                    */
                      ...
                      OS_ERR  *p_err)
{
    ...
    if (p_tcb == &OSIdleTaskTCB[0] || p_tcb == &OSIdleTaskTCB[1]) {                          /* Make sure not suspending the idle task                 */
