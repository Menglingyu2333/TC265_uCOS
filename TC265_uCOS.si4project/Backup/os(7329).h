...
extern            CPU_DATA                  OSPrioTbl[CPU_CORE_NUM][OS_PRIO_TBL_SIZE];
...
extern  OS_TCB_CTX_EXT OSCfg_IdleTask1Ext;
extern  OS_TCB_CTX_EXT OSCfg_IdleTask2Ext;

#if (OS_CFG_ISR_POST_DEFERRED_EN > 0u)
extern  CPU_STK        OSCfg_IntQTaskStk[];
extern  OS_INT_Q       OSCfg_IntQ[];
extern  OS_TCB_CTX_EXT OSCfg_IntQTaskExt;
#endif
...
extern  OS_TCB_CTX_EXT OSCfg_StatTaskExt;
#endif

extern  CPU_STK        OSCfg_TickTaskStk[];
extern  OS_TCB_CTX_EXT OSCfg_TickTaskExt;
extern  OS_TICK_SPOKE  OSCfg_TickWheel[];

#if (OS_CFG_TMR_EN > 0u)
extern  CPU_STK        OSCfg_TmrTaskStk[];
extern  OS_TCB_CTX_EXT OSCfg_TmrTaskExt;
