...
IFX_INLINE void IfxCpu_MyinitCSA0(uint32 *csa0Begin, uint32 *csa0End, uint32 *csa1Begin, uint32 *csa1End)
{
    uint32  k;
    uint32  nxt_cxi_val = 0;
    uint32 *prvCsa      = 0U;
    uint32 *nxtCsa      = csa0Begin;
    uint32  numOfCsa    = (((uint32)csa0End - (uint32)csa0Begin) / 64U);
    ...
    *prvCsa = 0;
    ...
    nxtCsa      = csa1Begin;
    numOfCsa    = (((uint32)csa1End - (uint32)csa1Begin) / 64U);
