...
CPU_STK        OSCfg_IdleTaskStk1[OS_CFG_IDLE_TASK_STK_SIZE];
CPU_STK        OSCfg_IdleTaskStk2[OS_CFG_IDLE_TASK_STK_SIZE];
OS_TCB_CTX_EXT OSCfg_IdleTask1Ext;
OS_TCB_CTX_EXT OSCfg_IdleTask2Ext;

#if (OS_CFG_ISR_POST_DEFERRED_EN > 0u)
OS_INT_Q       OSCfg_IntQ          [OS_CFG_INT_Q_SIZE];
CPU_STK        OSCfg_IntQTaskStk   [OS_CFG_INT_Q_TASK_STK_SIZE];
OS_TCB_CTX_EXT OSCfg_IntQTaskExt;
#endif
